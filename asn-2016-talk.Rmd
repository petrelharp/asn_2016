...
**geography ${}+{}$ dispersal ${}+{}$ temporal dynamics** affect
...
Proportion of circle covered by habitat type, at various radii

```{r habitat_one_sigma_again, echo=FALSE, cache=2, depends="setup_habitat_one_sigma", fig.height=0.75*fig.dim}
refpoint.list <- list( 
...
![Creosote](desert_veg/thumbs/central_Creosote.png)

----------

![Blackbrush](desert_veg/thumbs/central_Blackbrush.png)

----------

![Wash](desert_veg/thumbs/central_Low_Elevation_Wash_System.png)
...
speeds$habitat <- factor(gsub(".chaparral","",gsub(".wetland","",gsub("central ","",speeds$habitat))))
```
...
![drift against pop size](drift-vs-popsize.png)
