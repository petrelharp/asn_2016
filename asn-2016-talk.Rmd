...
if (!file.exists("desert_veg_central_small_raster.grd")) {
    ...
    writeRaster(rasterveg, file="desert_veg_central_small_raster.grd")
} else {
    rasterveg <- raster("desert_veg_central_small_raster.grd")
}
...
for (vegtype in names(wildfire.sims)) {
    plot.simulation(wildfire.sims[[vegtype]]$sim,wildfire.sims[[vegtype]]$pop,
                animate=paste("spatial-sweep-",gsub(" ","_",vegtype),"wash.mp4",sep=''))
}
```
